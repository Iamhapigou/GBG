...
ROOT_PATH = "C:/Users/iwise/Desktop/thethird/experiment/dataset/"
...
class FemnistDataset(Dataset):
    ...
    def get_images(self):
        ...
        for i in range(len(self.data)):
            path = os.path.join(ROOT_PATH, Path(self.data[i][0]).as_posix())
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(os.path.dirname(ROOT_PATH), save_path)
