...
import numpy as np
import random
from experiment.dataset_utils import word_to_indices, letter_to_index

random.seed(1)
np.random.seed(1)
data_path_train = "data/all_data_niid_2_keep_0_train_9.json"
data_path_test = "data/all_data_niid_2_keep_0_test_9.json"
dir_path = os.path.join(os.path.dirname(os.path.abspath('__file__')), 'Shakespeare/')
